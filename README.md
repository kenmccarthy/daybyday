...
Why This App Exists: Day by Day was built for my wife, Hazel, while she is undergoing chemotherapy for breast cancer. It started as a simple request: "Can you make me a spreadsheet to track my medications?"
...
Who It's For: Day by Day is for anyone going through treatment (or supporting someone who is) who needs a simple way to stay on top of a busy day – without turning life into a full-time admin job.
...
Private by Default: No accounts. No sign-in. No syncing. No server. Your data stays on your device and remains yours.

Helpful, Not Clinical: This isn't trying to be a medical system. It's meant to be quietly supportive: reminders, a record of the day, and quick access to useful information and contacts.

How It Works: Day by Day is a self-contained web app designed for a phone screen first. You can add it to your home screen and use it like an app.
...
Privacy & Data: Day by Day stores data locally in your browser on your device. There is no backend and no account system, so nothing is uploaded by default. If you choose to email a daily summary, that email is sent using your own email app and settings. You are in control of what is shared and with whom.

Acknowledgements: Day by Day was developed by Ken McCarthy. Generative AI tools – Claude and ChatGPT – were used during development to help draft, refine, and iterate the HTML, CSS, JavaScript, and interaction patterns based on prompt-driven instructions.

The app uses the following open-source libraries and external services:

Chart.js – for rendering symptom trend charts (chartjs.org)
Google Fonts – DM Sans and Fraunces typefaces (fonts.google.com)
Quotable API – for daily inspirational quotes (github.com/lukePeavey/quotable)
